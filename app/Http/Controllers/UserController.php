...
class UserController extends Controller
{
    ...
    public function receiverDashboard()
    {
        ...
        $users = User::where('isVerified', true)->take(5)->latest()->get();
        return view('receiver.dashboard', compact('users', 'receiver_count', 'donor_count', 'user_count', 'unverified_count', 'donation_count', 'active_count', 'pending_count', 'wasted_count'));
    }
