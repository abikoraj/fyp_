                    ...
                    <tr>
                                ...
                                <div class="post-info2">
                                    <div class="post-main-title">
                                        <a href="" class="text-gray-900 f-size-16  ft-wt-5">
                                            {{-- {{ Str::limit($job->title, 40, '...') }} --}} Donation name
                                        </a>
                                    </div>
                        ...
                        <td>
                            <div class="db-job-btn-wrap d-flex justify-content-end">
                                <a href="" class="btn bg-gray-50 text-primary-500 rt-mr-8">
                                        ...
                                        <a href="" class="dropdown-item">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#0A65CC" stroke-width="1.5" stroke-miterlimit="10" />
                                                <path d="M6.875 10H13.125" stroke="#0A65CC" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M10 6.875V13.125" stroke="#0A65CC" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            <button type="submit" class="dropdown-item">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    ...
                                                    <path
                                                        d="M10 17.5C14.1421 17.5 17.5 14.1421 17.5 10C17.5 5.85786 14.1421 2.5 10 2.5C5.85786 2.5 2.5 5.85786 2.5 10C2.5 14.1421 5.85786 17.5 10 17.5Z"
                                                        stroke="#5E6670" stroke-width="1.5" stroke-miterlimit="10">
                                                    </path>
                                                    <path d="M12.5 7.5L7.5 12.5" stroke="#5E6670" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M12.5 12.5L7.5 7.5" stroke="#5E6670" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                                </svg>
                                                {{ __('make_it_expire') }}
                                            </button>
